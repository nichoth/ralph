...
- **Spec Path**: [Link to the detailed .md file]
...
- **Keywords**: sqlite, d1, schema, migrations, sql, query, insert, update, crud, repository, database-layer, entities.
- **Spec Path**: [specs/database.md](./database.md)

## Example: Internationalization

- **Keywords**: i18n, translations, locales, language, l10n, strings, multi-language, loom-i18n.
- **Spec Path**: [specs/i18n.md](./i18n.md)
